...
class MSRVTT_DataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        return pairs_text, pairs_mask, video, video_mask, idx, video_id
        # return pairs_text, pairs_mask, video, video_mask, idx, hash(video_id.replace("video", ""))
...
class MSRVTT_TrainDataLoader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        video, video_mask = self._get_rawvideo(choice_video_ids)
        return pairs_text, pairs_mask, video, video_mask, idx
