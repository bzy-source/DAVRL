...
class Attention(nn.Module):
    ...
    def forward(self, x, attn_mask):
        ...
        qkv_delta = F.linear(x, self.TVPt_LoRA_a) # [64, 32, 512] text
        qkv_delta = F.linear(qkv_delta, self.TVPt_LoRA_b).reshape(bsz, tgt_len, 3, self.num_heads, embed_dim // self.num_heads).permute(2, 0, 3, 1, 4) # [3, 64, num_heads, tgt_len, dim]
